...
if run_simulations == 'y':
    ...
    for j in np.arange(1,5):    
        ...
        if j==2:
            ...
            dz = data.H[-1]-d
            data.H = data.H-dz
            # may need to start this one over since dU/dx = 0 at x=L
        ...
        data.save('steady-state_Bdot_-0.60_21pts' + file_extensions[j] + '.pickle')    
...
axes[4].legend(['default',r'$d=10$ m',r'$b=5\times 10^4$',r'$A=0$',r'$\mu_s=0.2$'],framealpha=1)
